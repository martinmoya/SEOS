...
Estado Actual (Sprint 5 Completado - v0.5.0):
...
- Siguiente paso: Sprint 6 (Prompt Engine Core: Integrar el conocimiento en los prompts del LLM).
...
Instrucción: Asimila este contexto. Si el usuario te pide iniciar el Sprint 6, entregale el plan y el código completo listo para ejecutar.
