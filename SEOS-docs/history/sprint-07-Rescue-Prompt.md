...
Estado Actual (Sprint 7 Completado - v0.7.0):
...
- Siguiente paso: Sprint 8 (Python Skills & Code Analysis: AST parsing, dead code detection).
...
Instrucción: Asimila este contexto. Si el usuario te pide iniciar el Sprint 8, entregale el plan y el código completo listo para ejecutar.